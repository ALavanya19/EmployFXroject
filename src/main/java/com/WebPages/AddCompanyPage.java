...
public class AddCompanyPage extends Base {
	...
	//Object Repository
	//Add Company Page Heading Label text
	@FindBy(xpath="//h1[text()='Add Company ']")
	WebElement headingLabelText;
	
	//Add Company Page Sub Heading Label Text
	@FindBy(xpath="//h3[text()='Company Details ']")
	WebElement subHeadingLabelText;
	...
	@FindBy(xpath="/html/body/app-root/div/mat-drawer-container/mat-drawer-content/div/div/app-add-compnay/div[2]/div/div[2]/div/form/div[2]/div/div/div/button[1]")
	WebElement resetButtonE;
	
	//Cancel Button Element
	@FindBy(xpath="/html/body/app-root/div/mat-drawer-container/mat-drawer-content/div/div/app-add-compnay/div[2]/div/div[2]/div/form/div[2]/div/div/div/button[2]")
	WebElement cancelButtonE;
	
	//Save Button Element
	@FindBy(xpath="/html/body/app-root/div/mat-drawer-container/mat-drawer-content/div/div/app-add-compnay/div[2]/div/div[2]/div/form/div[2]/div/div/div/button[3]")
	...
	public String addCompanyPage_CurrentURL_Validation() {
		return driver.getCurrentUrl();
	}
	
	//Add Company Page Title Validation
	public String addCompanyPage_Title_Validation() {
		return driver.getTitle();
	}
	
	//Add Company Page Heading Label Text
	public String addCompanyPage_HeadingLabelText_Validation() {
		return headingLabelText.getText();
	}
	
	//Add Company Page Sub Heading Label Text
	public String addCompanyPage_SubHeadingLabelText_Validation() {
		return subHeadingLabelText.getText();
	}
	

	
	public void addCompanyPage_AllFieldsSave_Validation(List<Object>AllFieldsData,List<Object>operatingCountries,List<Object>operatingStates) throws InterruptedException, AWTException, IOException {
		
		addCompanyPage_AllFieldsData(AllFieldsData, operatingCountries, operatingStates);
		saveButtonE.click();
		
	}
	
	public void addCompanyPage_AllFieldsCancel_Validation(List<Object>AllFieldsData,List<Object>operatingCountries,List<Object>operatingStates) throws InterruptedException, AWTException, IOException {
	    
		addCompanyPage_AllFieldsData(AllFieldsData, operatingCountries, operatingStates);
		cancelButtonE.click();	
	}
	
	public void addCompanyPage_AllFieldsReset_Validation(List<Object>AllFieldsData,List<Object>operatingCountries,List<Object>operatingStates) throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(2500);
		//CommonActions.checkMandatoryFieldValidation(operatingCountriesE);
	...
	public void addCompanyPage_AllFieldsData(List<Object>AllFieldsData,List<Object>operatingCountries,List<Object>operatingStates) throws InterruptedException, AWTException, IOException {
		Actions act=new Actions(driver);
		Robot robot=new Robot();
		WebDriverWait wait=CommonActions.webDriverWaitMethod();
		...
		//CommonActions.checkMandatoryFieldValidation(businessCategoryE);
		...
		emailE.sendKeys((CharSequence)AllFieldsData.get(8).toString());
		CommonActions.checkMandatoryFieldValidation(emailE);
		...
		java.lang.Runtime.getRuntime().exec(AllFieldsData.get(11).toString());
	...
	public void addCompanyPage_Mandatoryfields_Validation(List<Object>AllFieldsData,List<Object>operatingCountries,List<Object>operatingStates) throws InterruptedException, AWTException, IOException {
		Actions act=new Actions(driver);
		Robot robot=new Robot();
		WebDriverWait wait=CommonActions.webDriverWaitMethod();
		...
		emailE.sendKeys((CharSequence)AllFieldsData.get(7).toString());
		CommonActions.checkMandatoryFieldValidation(emailE);
		
		phoneNumberE.sendKeys((CharSequence)AllFieldsData.get(8).toString());
		CommonActions.checkMandatoryFieldValidation(phoneNumberE);
		
		primaryTitleE.click();
		for(int option=0;option<primaryTitleList.size();option++) {
			String actualTitle=primaryTitleList.get(option).getText();
			if(actualTitle.equalsIgnoreCase((String)AllFieldsData.get(9).toString())) {
				primaryTitleList.get(option).click();
			}
		}
		//CommonActions.checkMandatoryFieldValidation(primaryTitleE);
		
		primaryContactNameE.sendKeys((CharSequence)AllFieldsData.get(10).toString());
		CommonActions.checkMandatoryFieldValidation(primaryContactNameE);
		
		primaryCountryFilterE.sendKeys((CharSequence)AllFieldsData.get(11).toString());
		wait.until(ExpectedConditions.visibilityOfAllElements(primaryCountriesList));
		primaryCountriesList.get(0).click();
		CommonActions.checkMandatoryFieldValidation(primaryCountryFilterE);
		
		primaryStateFilterE.sendKeys((CharSequence)AllFieldsData.get(12).toString());
		wait.until(ExpectedConditions.visibilityOfAllElements(primaryStatesListE));
		Thread.sleep(1300);
		primaryStatesListE.get(0).click();
		robot.keyPress(KeyEvent.VK_ENTER);
		...
		primaryStreetAddressE.sendKeys((CharSequence)AllFieldsData.get(13).toString());
		CommonActions.checkMandatoryFieldValidation(primaryStreetAddressE);
		
		primaryPhoneNumberE.sendKeys((CharSequence)AllFieldsData.get(14).toString());
		CommonActions.checkMandatoryFieldValidation(primaryPhoneNumberE);
		
		totalNumberOfEmployeesE.sendKeys((CharSequence)AllFieldsData.get(15).toString());
		CommonActions.checkMandatoryFieldValidation(totalNumberOfEmployeesE);
	...
	public void addCompany_WithoutSecondaryDetails_Validation(List<Object>AllFieldsData,List<Object>operatingCountries,List<Object>operatingStates) throws InterruptedException, AWTException, IOException {
		Actions act=new Actions(driver);
		Robot robot=new Robot();
		WebDriverWait wait=CommonActions.webDriverWaitMethod();
		...
		totalNumberOfEmployeesE.sendKeys((CharSequence)AllFieldsData.get(24).toString());
		CommonActions.checkMandatoryFieldValidation(totalNumberOfEmployeesE);
